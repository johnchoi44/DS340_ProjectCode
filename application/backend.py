...
model = joblib.load(r"application\models\xgboost.joblib")
crime_types = {0:'Violation',1:"Misdemeanor",2:"Felony"}
felony = open(r"application\crime_types\felony.txt","r").read()
mis = open(r"application\crime_types\misdemeanor.txt","r").read()
violation = open(r"application\crime_types\violation.txt","r").read()
